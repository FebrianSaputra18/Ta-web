...
<head>
    ...
    <!-- Title Page-->
    <title>Dashboard | UD. MAHMUDA</title>
...
<body class="animsition">
            ...
            <div class="section__content section__content--p35">
                <div class="header3-wrap">
                    <div class="header__logo">
                        <a href="#">
                            <a class="navbar-brand col-sm-3 col-1" href="#"><img
                                    src="{{ asset ('style/images/bg_title.png')}}" alt=""></a>
                        </a>
                    </div>
    ...
    <!-- Main JS-->
    <script src="{{asset('style/js/thirdmain.js')}}"></script>
